...
public class AddressedSafetyMessage {
  ...
  public AddressedSafetyMessage messageID(@javax.annotation.Nonnull Integer messageID) {
  ...
  public AddressedSafetyMessage repeatIndicator(@javax.annotation.Nonnull Integer repeatIndicator) {
  ...
  public AddressedSafetyMessage userID(@javax.annotation.Nonnull Integer userID) {
    this.userID = userID;
    return this;
  }
  ...
  public AddressedSafetyMessage valid(@javax.annotation.Nonnull Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public AddressedSafetyMessage sequenceinteger(@javax.annotation.Nonnull Integer sequenceinteger) {
  ...
  public AddressedSafetyMessage destinationID(@javax.annotation.Nonnull Integer destinationID) {
  ...
  public AddressedSafetyMessage retransmission(@javax.annotation.Nonnull Boolean retransmission) {
  ...
  public AddressedSafetyMessage spare(@javax.annotation.Nonnull Boolean spare) {
    this.spare = spare;
    return this;
  }
  ...
  public AddressedSafetyMessage text(@javax.annotation.Nonnull String text) {
    this.text = text;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddressedSafetyMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddressedSafetyMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddressedSafetyMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddressedSafetyMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
