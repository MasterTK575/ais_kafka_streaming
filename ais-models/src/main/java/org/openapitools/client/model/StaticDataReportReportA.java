...
public class StaticDataReportReportA {
  ...
  public StaticDataReportReportA valid(@javax.annotation.Nonnull Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public StaticDataReportReportA name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StaticDataReportReportA
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StaticDataReportReportA.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StaticDataReportReportA.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StaticDataReportReportA` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
