...
public class AddressedBinaryMessage {
  ...
  public AddressedBinaryMessage messageID(@javax.annotation.Nonnull Integer messageID) {
  ...
  public AddressedBinaryMessage repeatIndicator(@javax.annotation.Nonnull Integer repeatIndicator) {
  ...
  public AddressedBinaryMessage userID(@javax.annotation.Nonnull Integer userID) {
    this.userID = userID;
    return this;
  }
  ...
  public AddressedBinaryMessage valid(@javax.annotation.Nonnull Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public AddressedBinaryMessage sequenceinteger(@javax.annotation.Nonnull Integer sequenceinteger) {
  ...
  public AddressedBinaryMessage destinationID(@javax.annotation.Nonnull Integer destinationID) {
  ...
  public AddressedBinaryMessage retransmission(@javax.annotation.Nonnull Boolean retransmission) {
  ...
  public void setRetransmission(@javax.annotation.Nonnull Boolean retransmission) {
    this.retransmission = retransmission;
  }


  public AddressedBinaryMessage spare(@javax.annotation.Nonnull Boolean spare) {
    this.spare = spare;
    return this;
  }
  ...
  public AddressedBinaryMessage applicationID(@javax.annotation.Nonnull AddressedBinaryMessageApplicationID applicationID) {
  ...
  public AddressedBinaryMessage binaryData(@javax.annotation.Nonnull String binaryData) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddressedBinaryMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddressedBinaryMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddressedBinaryMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddressedBinaryMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
