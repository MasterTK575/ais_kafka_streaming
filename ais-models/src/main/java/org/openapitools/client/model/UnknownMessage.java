...
public class UnknownMessage {
  ...
  public UnknownMessage error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnknownMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnknownMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnknownMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnknownMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
